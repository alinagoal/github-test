#!/bin/bash
  ...
  INTEGRATIONS_API_URL='https://3000-qualitiai-qualitiapi-iqi3ua6u526.ws-us62.gitpod.io'
  PROJECT_ID='3'
  CLIENT_ID='88b70bc343365e1f4ea9d1481f7cd18b'
  SCOPES=['"ViewTestResults"','"ViewAutomationHistory"']
  API_URL='https://3000-qualitiai-qualitiapi-iqi3ua6u526.ws-us62.gitpod.io/public/api'
